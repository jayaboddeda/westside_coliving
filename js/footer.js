...
(function () {
  ...
  var FOOTER_HTML = [
    ...
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Rooms &amp; Pricing</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Amenities</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Food Menu</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Gallery</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">FAQs</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Contact</span>',
    '      </div>',
    '    </div>',
    '',
    '    <div>',
    ...
    '      <div class="flex flex-col gap-2.5 text-sm">',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Terms &amp; Conditions</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Lock-in Period</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Notice Period</span>',
    '        <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Security Deposit</span>',
    '      </div>',
    '    </div>',
    '',
    '    <div>',
    ...
    '      <p><span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Terms &amp; Conditions</span> &nbsp;|&nbsp; <span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Contact</span></p>',
    '    </div>',
    '  </div>',
    '</footer>'
  ].join('\n');
