...
(function () {
  ...
  var FOOTER_HTML = [
    ...
    '      <p><a href="terms.html" class="hover:text-gold-light transition-colors">Terms &amp; Conditions</a> &nbsp;|&nbsp; <a href="contact.html" class="hover:text-gold-light transition-colors">Contact</a></p>',
    '    </div>',
    '  </div>',
    '</footer>'
  ].join('\n');
