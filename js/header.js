...
(function () {
  ...
  var HEADER_HTML = [
    ...
    '      <li>',
    '        <a href="contact.html" data-nav="contact.html" class="inline-flex items-center gap-2 rounded-full bg-ink text-cream px-5 py-2.5 hover:bg-gold hover:text-ink transition-colors">',
    ...
    '    <a href="faq.html" data-nav="faq.html" class="flex items-center justify-between py-3.5 border-b border-ink/8 hover:text-gold-deep transition-colors">FAQ <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></a>',
    '    <a href="contact.html" data-nav="contact.html" class="flex items-center justify-between py-3.5 hover:text-gold-deep transition-colors">Contact <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></a>',
    '  </nav>',
    '  <div class="px-5 pb-7 pt-3 border-t border-ink/10">',
    '    <a href="contact.html" data-nav="contact.html" class="flex justify-center items-center gap-2 rounded-full bg-ink text-cream px-5 py-3.5 font-semibold hover:bg-gold hover:text-ink transition-colors">',
    '      Enquire Now <svg class="ic w-4 h-4"><use href="#i-arrow"/></svg>',
    '    </a>',
