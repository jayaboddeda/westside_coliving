...
(function () {
  ...
  var HEADER_HTML = [
    ...
    '  <div class="max-w-7xl mx-auto px-6 flex items-center justify-between h-[104px] lg:h-[116px]">',
    '    <a href="index.html" class="flex items-center group">',
    '      <img src="images/logo_circle.png" alt="Westside Coliving" class="h-24 lg:h-28 w-auto" />',
    '    </a>',
    '',
    ...
    '      <li><span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Rooms &amp; Pricing</span></li>',
    '      <li><span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Amenities</span></li>',
    '      <li><span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Food Menu</span></li>',
    '      <li><span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">Gallery</span></li>',
    '      <li><span aria-disabled="true" title="Coming soon" class="opacity-40 cursor-not-allowed select-none">FAQ</span></li>',
    '      <li>',
    '        <span aria-disabled="true" title="Coming soon" class="inline-flex items-center gap-2 rounded-full bg-ink/40 text-cream/70 px-5 py-2.5 cursor-not-allowed select-none">',
    ...
    '      <img src="images/logo_circle.png" alt="Westside Coliving" class="h-16 w-auto" />',
    '    </span>',
    ...
    '    <span aria-disabled="true" title="Coming soon" class="flex items-center justify-between py-3.5 border-b border-ink/8 opacity-40 cursor-not-allowed select-none">Rooms &amp; Pricing <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></span>',
    '    <span aria-disabled="true" title="Coming soon" class="flex items-center justify-between py-3.5 border-b border-ink/8 opacity-40 cursor-not-allowed select-none">Amenities <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></span>',
    '    <span aria-disabled="true" title="Coming soon" class="flex items-center justify-between py-3.5 border-b border-ink/8 opacity-40 cursor-not-allowed select-none">Food Menu <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></span>',
    '    <span aria-disabled="true" title="Coming soon" class="flex items-center justify-between py-3.5 border-b border-ink/8 opacity-40 cursor-not-allowed select-none">Gallery <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></span>',
    '    <span aria-disabled="true" title="Coming soon" class="flex items-center justify-between py-3.5 opacity-40 cursor-not-allowed select-none">FAQ <svg class="ic w-4 h-4 opacity-40"><use href="#i-arrow"/></svg></span>',
    '  </nav>',
    '  <div class="px-5 pb-7 pt-3 border-t border-ink/10">',
    '    <span aria-disabled="true" title="Coming soon" class="flex justify-center items-center gap-2 rounded-full bg-ink/40 text-cream/70 px-5 py-3.5 font-semibold cursor-not-allowed select-none">',
    '      Enquire Now <svg class="ic w-4 h-4"><use href="#i-arrow"/></svg>',
    '    </span>',
